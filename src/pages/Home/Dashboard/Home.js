...
import Pic1 from "../../../assets/images/popular-img/review-img/pic-1.jpg";
import Pic2 from "../../../assets/images/popular-img/review-img/pic-2.jpg";
import Pic3 from "../../../assets/images/popular-img/review-img/pic-3.jpg";
import BannerPic from "../../../assets/images/banner-img/pic-2.jpg";
    ...
    <>
      <div className="container mt-5">
        <div className="row mt-5">
          <div className="col-xl-8 col-xxl-7 mt-5">
            <div className="row">
          ...
          <div className="col-xl-4 col-xxl-5 mt-5">
            <div className="row">
              <div className="col-xl-12">
